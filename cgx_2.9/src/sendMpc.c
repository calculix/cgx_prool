...
void areampc(int set1, int set2, char *format, char *type, char *value, char *corr, int flag, Nodes *nptr)
{
  ...
  FILE  *handle=NULL, *handle_pid=NULL, *handle_boundary=NULL;

  int n0, n1, n2;
  int   indeql, elbuf=0, anz_n, neqn_ini=0;
