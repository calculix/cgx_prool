...
void calcDatasets( int lc, Summen *anz, Nodes *node, Datasets *lcase )
{
  ...
  if( (compare( lcase[lc].name, "STRESS", 6) == 6)||(compare( lcase[lc].name, "STRAIN", 6) == 6)||( compare( lcase[lc].name, "TOSTRAIN", 6) == 6)||( compare( lcase[lc].name, "MESTRAIN", 6) == 6)||( compare( lcase[lc].name, "ELSTRAIN", 6) == 6)||( compare( lcase[lc].name, "ZZS", 3) == 3))
