...
void help( void )
{
  ...
  printf ("   'elty' [] | [<set> 'be2'|'be2f'|'be2d'|'be3'|'be3f'|'tr3'|'tr3u'|'tr3e'|'tr3s'|'tr3c'|'tr6'|'tr6u'|'tr6e'|'tr6s'|'tr6c'|'qu4'|'qu4e'|'qu4s'|'qu4c'|'qu8'|'qu8e'|'qu8s'|'qu8c'|'he8'|'he8f'|'he8i'|'he8r'|'he20'|'he20r'|'te4'|'te10'|'pe6'|'pe6f'|'pe6i'|'pe15'|'pe15r' [<parameter>]]\n");
  printf ("   'else'\n");
...
int coneToNurs(int s)
{
  ...
  char buffer[MAX_LINE_LENGTH];
  double rad1, rad2, qrad, drad, f,ft;
