...
#define     MAX_REFINEMENT_LOOPS     3     // nr of loops to adjust line divisions on element edges
...
/* default location of the help files, please insert the actual one */
  ...
  #else
    #define     HELPFILE        {"/yaprod/cae/application/CalculiX/doc/cgx_2.16/cgx.html",\
                             "/yaprod/cae/application/CalculiX/doc/ccx_2.14/ccx.html"}
  #endif
#elif defined AFLIB
...
int generateTetFromBody(int nr, double teth, int eattr);
int generateTetFromSet(int setNr, double teth, int eattr);
