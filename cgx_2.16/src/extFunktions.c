...
void help( void )
{
  ...
  printf ("   'area' <set> \n");
  printf ("   'asgn' ['n'|'e'|'p'|'l'|'c'|'s'|'b'|'S'|'L'|'se'|'sh'|'alpha'|'beta'|'nadapt' <value>]|['thrds' <value>]|['rbe' <value>|'mpc']\n");
  ...
  printf ("   'ori' <set>\n");
  printf ("   'plot' ['n'|'e'|'f'|'p'|'l'|'s'|'b'|'S'|'L'|'sh']&['a'|'b'|'d'|'n'|'p'|'q'|'t'|'v'] <set> ['w'|'k'|'n'|'r'|'g'|'b'|'y'|'m'|'t'|'c'|'o'] [<width>]\n");
  printf ("   'plus' ['n'|'e'|'f'|'p'|'l'|'s'|'b'|'S'|'L'|'sh']&['a'|'b'|'d'|'n'|'p'|'q'|'t'|'v'] <set> ['w'|'k'|'n'|'r'|'g'|'b'|'y'|'m'|'t'|'c'|'o'] [<width>]\n");
  ...
  printf ("   'view' 'fill'|'line'|'point' <value>|'edge' ['off'|<value>]|'elem' ['off']|'surf'|'volu'|'front'|'back'|'vec' ['off']|'disp' ['off']|'bg' ['w'|'k']|'sh' ['off']|'ill' ['off']|'rul' ['off'|<string>]\n");
  printf ("   'volu' <set>\n");
